...
//show password with guessed letters
...
//display game in initial stage with clean letters
function start() {
    var div_content = "";
...
//create partial password with some letters guessed
...
function gameOver() {
    ...
    end.innerHTML = "Game Over<br/><br/>Password was:<br/><span>"+password+"</span>";
